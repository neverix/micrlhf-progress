...
results = []
for i in range(4):
    with open(f"cleanup_results_new_32_shots_{i}.jsonl") as f:
        lines = f.readlines()
...
for task_name in task_names:
    ...
    for result in task_results:
        ...
        print(task_name, np.nonzero(w)[0].tolist(), w[np.nonzero(w)[0]].tolist())
        # print(
