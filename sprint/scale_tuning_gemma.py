...
with safe_open("models/sae/gemma.safetensors", framework="numpy") as st:
...
generations_filename = "data/gemma-2b-generations-2.json"
...
try:
    ...
    pass
json.dump(generations, open(generations_filename, "w"))
